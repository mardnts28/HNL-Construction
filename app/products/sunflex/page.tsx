...
export default function SunflexProductDetail() {
  const specs: FeatureItem[] = [
    { title: "Smooth Folding Mechanism", desc: "Engineered pivot hinges enable effortless opening and closing of large glass panels." },
    { title: "Seamless Weather Seal", desc: "Integrated gasket system prevents water ingress while maintaining a sleek profile." },
    { title: "Customizable Configurations", desc: "Available in bi-fold, tri-fold, and multi-panel setups to suit any space." },
    { title: "High Structural Strength", desc: "Reinforced aluminum frames meet stringent wind‑load and seismic standards." },
    { title: "Premium Glass Options", desc: "Choice of laminated, tempered, or low‑E glass for performance and aesthetics." },
  ];

  const gallery: GalleryItem[] = [
    {
      image: "/images/project_condo.png",
      caption: "Sunflex Folding System – Condo",
      scope: "Residential High‑Rise, Cebu",
    },
    {
      image: "/images/office_photo.png",
      caption: "Sunflex in Commercial Space",
      scope: "Office Lobby, Makati",
    },
    {
      image: "/images/hero_bg.png",
      caption: "Sunflex on Luxury Villa",
      scope: "Villa Facade, Taguig",
    },
  ];
    ...
    <div className="flex flex-col w-full min-h-screen">
      ...
      <section className="relative flex h-[45vh] min-h-[350px] items-center justify-center overflow-hidden bg-brand-dark text-white">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Sunflex product hero background"
            fill
            priority
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8 flex flex-col gap-3 animate-fade-in">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl text-white">Sunflex Folding Systems</h1>
          <p className="max-w-2xl text-base sm:text-lg text-zinc-300 leading-relaxed mx-auto">
            Elegant, space‑saving folding glass doors that blend indoor and outdoor living.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-12">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              ...
              <h2 className="text-3xl font-bold tracking-tight text-brand-dark sm:text-4xl">
                Transformative Folding Door Solutions
              </h2>
              <div className="text-zinc-600 space-y-5 leading-relaxed text-base">
                <p>
                  Sunflex systems combine precision‑engineered aluminium frames with high‑performance glass to create seamless folding doors that open up spaces dramatically. Ideal for residential terraces, commercial lounges, and hospitality venues.
                </p>
                <p>
                  The modular design allows for a range of panel counts and configurations, delivering flexibility without compromising structural integrity or weather protection.
                </p>
              </div>
            </div>
      ...
      <section className="bg-brand-bg py-20 sm:py-28 border-t border-brand-secondary/15">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center flex flex-col gap-4 mb-16 sm:mb-20">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-brand-dark sm:text-4xl">Sunflex in Action</h2>
            <p className="text-base sm:text-lg text-zinc-500 leading-relaxed">Explore installations showcasing the fluid elegance and functional performance of Sunflex folding systems.</p>
          </div>
      ...
      <section className="bg-brand-dark py-16 sm:py-20 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8 flex flex-col items-center gap-6">
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Ready to Experience Sunflex?</h2>
          <p className="max-w-2xl text-base text-zinc-300 leading-relaxed">
            Contact our design team to discuss custom configurations, performance specifications, and pricing tailored to your project.
          </p>
          <div className="mt-2">
